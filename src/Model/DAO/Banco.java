...
public class Banco {
    ...
    public static ArrayList<Agendamentos> agendamento;
    ...
    public static void inicia(){
        ...
        agendamento = new ArrayList<Agendamentos>();
        ...
        Agendamentos agendamento1 = new Agendamentos(1, cliente1, servico2, 30, "14/07/2018 09:30");
        Agendamentos agendamento2 = new Agendamentos(2, cliente3, servico4, 40, "14/07/2018 10:00");
        Agendamentos agendamento3 = new Agendamentos(3, cliente4, servico1, 18, "14/07/2018 10:30");
