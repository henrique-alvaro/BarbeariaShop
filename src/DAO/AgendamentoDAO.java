...
public class AgendamentoDAO {
     ...
     */
    public void insert(Agendamentos agendamento){
     ...
     * @return 
     */
    public boolean update(Agendamentos agendamento){
     ...
     * @return 
     */
    public boolean delete(Agendamentos agendamento){
        for (Agendamentos agendamentoLista : Banco.agendamento) {
     ...
     */
    private boolean idSaoIguais(Agendamentos agendamento, Agendamentos agendamentoAComparar) {
    ...
    private int proximoId(){
        ...
        for (Agendamentos agendamento : Banco.agendamento) {           
